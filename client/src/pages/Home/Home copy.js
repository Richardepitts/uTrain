...
const Home = (props) =>  {
    ...
    <div className="HomeParentContainer">
            ...
            <div id='HomeWhiteboard' className={isPhone ? 'HomeWhiteboardPhone' : 'HomeWhiteboard'}>
            <div className={isPhone ? 'HomeWhiteboardTextPhone' : 'HomeWhiteboardText'}>
                     ...
                     <div className={isPhone ? 'HomeDynamicUsernameContainerPhone' : 'HomeDynamicUsernameContainer'}>
                            ...
                            {/* <div className="HomeUserNameInteriorContainer">
                                <span className='HomeUsername'>{signature.replace(/["']/g, "")}</span>
                            </div> */}
                        </div>
