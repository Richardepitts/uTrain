...
const Home = (props) =>  {
    ...
    <div className="HomeParentContainer">
            ...
            <div id='HomeWhiteboard' className={isPhone ? 'HomeWhiteboardPhone container' : 'HomeWhiteboard container'}>
            <div className={isPhone ? 'HomeWhiteboardTextPhone' : 'HomeWhiteboardText'}>

            {/* <div className="container"> */}
        <div className="WelcomeXD">
            <div className='HomeWelcomeTextD'>Welcome</div>
        </div>
        <div className="HomeGainsXD">

        <div className={isPhone ? 'invisibleClass' : 'HomeGainsDynamicContainerD'}>
                        <div className='HomeDisplayContainerD upperBodyGainsD'>
                            <span>Upper Body Gains:</span>
                            <span>{upperBodyGains}%</span>
                            </div>
                        <div className='HomeDisplayContainerD lowerBodyGainsD'>
        ...
        <div className="HomeWeightsXD">
        <div className={isPhone ? 'invisibleClass' : 'HomeWeightDynamicContainerD'}>
                    <div className='HomeDisplayContainerD currentWeightD'>
                            <span>Current Weight: </span>
                            <span>{currentWeight}</span>
                            </div>
                        <div className='HomeDisplayContainerD goalWeightD'>
        ...
        <div className="HomeMacrosXD">
        {/* <div className={'HomeDynamicMacrosContainer'}> */}
                            <div className={isPhone ? 'HomeMacrosContainerPhone' : 'HomeMacrosContainerD'}>
        ...
        <div className="HomeTotalCaloriesContainerXD">
        <div className={isPhone ? 'HomeDynamicTotalCaloriesContainerPhone' : 'HomeDynamicTotalCaloriesContainerD'}>
      ...
      {/* </div> */}
                    ...
                    <div className={isPhone ? 'invisibleClass' : 'HomeGainsDynamicContainer'}>
                        <div className='HomeDisplayContainerD'>
                            <span>Upper Body Gains</span>
                            </div>
                        <div className='HomeDisplayContainerD'>
                            <span>{upperBodyGains}%</span>
